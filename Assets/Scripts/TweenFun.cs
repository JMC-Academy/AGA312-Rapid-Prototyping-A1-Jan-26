...
public class TweenFun : BehaviourX
{
    ...
    private void Start()
    {
        ...
        ExecuteAfterSeconds(2, () => print("You are great"));
    }
    ...
    {
        TweenX.TweenNumbers(scoreText, score, score + scoreBonus, scoreTweenTime, scoreEase, "F0");
